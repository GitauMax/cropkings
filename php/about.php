...
<div class="heading" style="background:url(images/web6.jpg) no-repeat">
   <h1>about us</h1>
</div>
...
<section class="about">
   ...
   <div class="content">
      <h3>why choose us?</h3>
      <p>We provide comprehensive and sustainable solutions and technical support
          to empower farmers with expert knowledge to improve agricultural productivity
           (profitability) and ensure sustainable growth in the agricultural sector.
          Our motive was encouraged by the realization of growing demand for agronomy 
          services by smallholder farmers across the country. </p>
   </div>
